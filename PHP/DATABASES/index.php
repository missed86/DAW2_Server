        ...
        <div id="contenido">
          ...
          <div id="addproduct">
            ...
            <form action="" method="POST">
              <p><label>Código: </label><input type="text" name="addCod"><p>
              <p><label>Nombre: </label><input type="text" name="addNombrecorto"><p>
              <p><label>Descripción: </label><input type="textarea" name="addDescripcion"><p>
              <p><label>PVP: </label><input type="text" name="addPvp"><p>
