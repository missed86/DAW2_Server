...
<body>
    ...
    <form action="" method="post">
        <p>Input1: <input type="number" name="array[]" value="<?php if (isset($_POST['a'])) echo $_POST['a'] ?>"></p>
        <p>Input2: <input type="number" name="array[]" value="<?php if (isset($_POST['b'])) echo $_POST['b'] ?>"></p>
