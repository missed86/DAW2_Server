...
games_url = "https://api.igdb.com/v4/screenshots"
def scrape_screenshots(games_url, offset):
    total = 0
    while True:
        ...
        if query.status_code == 200:
            ...
            try:
                ...
                mySql_insert_query = """INSERT INTO screenshots (id, alpha_channel, animated, game, height, width, image_id, url, checksum)
                ...
                #(id, alpha_channel, animated, game, height, width, image_id, url, checksum)
                    ...
                    connection.commit()
                    print(id, url, 'Successfully added', end = "\r")
                    total+=1
...
scrape_screenshots(games_url, offset)
