...
games_url = "https://api.igdb.com/v4/artworks"
def scrape_artworks(games_url, offset):
    total = 0
    while True:
        ...
        if query.status_code == 200:
            ...
            try:
                ...
                mySql_insert_query = """INSERT INTO artworks (id, alpha_channel, animated, game, height, width, image_id, url, checksum)
...
scrape_artworks(games_url, offset)
